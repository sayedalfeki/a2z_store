...
@Injectable(as: CategoryProductDataSource)
class CategoryProductOnlineDataSourceImpl extends CategoryProductDataSource
{
  final ApiManager apiManager;

  CategoryProductOnlineDataSourceImpl({required this.apiManager});
  @override
  Future<DataResponse<ProductDto>> getCategoryProducts(String categoryId)async {
    try
    {
